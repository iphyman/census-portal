    ...
    <div class="w-100 d-flex justify-content-center">
        <div class="card shadow-sm npc-card">
            <div class="card-header bg-success">
                <h4 class="text-center text-white">Add State</h4>
            </div>
                ...
                <form method="POST" action="{{ route('state.store') }}">
                    ...
                    <div class="input-group has-validation mb-3">
                        <div class="form-floating @error('capital') is-invalid @enderror">
                            <input id="capital"
                                class="form-control form-control-lg @error('capital') is-invalid @enderror"
                    ...
                    <div class="input-group has-validation mb-3">
                        <div class="form-floating @error('demonym') is-invalid @enderror">
                            <input id="demonym"
                                class="form-control form-control-lg @error('demonym') is-invalid @enderror"
